...
- Why did Semantic-distilled online-hard-memory source replicates on a fresh seed, but trusted handoff is seed-sensitive fail?
...
- Diagnose or improve source/readout geometry for handoff robustness, move to streaming/fresh-prompt memory, or validate a many-calculator/routed version if it directly tests scalability.
